...
<html>
<head>
	<title>Đăng nhập tài khoản người dùng - Nhóm Đỗng</title>
	<meta charset="utf-8">
...
<div class="w-full fixed top-0 left-0 right-0 z-50 shadow-md px-4 bg-white">
	...
	<div class="flex items-center justify-center mt-20 w-screen" style="height: calc(100vh - 80px);">
		<div class="" style="width: 480px;">
			<div class="mt-10 border-2 border-gray-100 rounded-md px-10 py-8 shadow-sm">
