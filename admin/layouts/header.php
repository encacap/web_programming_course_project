...
<body>
  ...
  <div class="flex">
    <div class="w-72 border-r-2 border-gray-100 px-4" style="height: calc(100vh - 80px)">
    ...
    echo "text-blue-500";
          ...
          <li class="nav-item font-semibold">
            <a href="<?= $baseUrl ?>product" class="flex items-center py-2">
              <div class="flex justify-center items-center w-16">
          ...
          <li class="nav-item font-semibold">
            <a href="<?= $baseUrl ?>order" class="flex items-center py-2">
              <div class="flex justify-center items-center w-16">
          ...
          <li class="nav-item font-semibold">
            <a href="<?= $baseUrl ?>user" class="flex items-center py-2">
              <div class="flex justify-center items-center w-16">
    ...
    <main role="main" class="flex-1 col-lg-10 px-4">
